      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            ...
            <Link href="/resources" className="text-sm font-medium text-roi-steel hover:text-roi-red transition-colors">
              Resources
            </Link>
          </nav>
        ...
        {mobileOpen && (
          <div className="lg:hidden border-t border-gray-100 py-4 space-y-1">
            ...
            <div className="border-t border-gray-100 pt-2 space-y-1">
              ...
              <Link href="/resources" onClick={() => setMobileOpen(false)} className="block text-sm font-medium text-roi-steel py-2">Resources</Link>
