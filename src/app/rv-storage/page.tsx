        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10">
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <div className="text-2xl font-bold text-roi-navy">{PRICING.rv.buildingPackageLabel}</div>
            </div>
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              <div className="text-xs text-gray-400 uppercase tracking-wider mb-1">+ Erection &amp; Concrete</div>
              <div className="text-2xl font-bold text-roi-navy">{PRICING.rv.erectionConcreteLabel}</div>
            </div>
